...
import { parseArgs, keepRangesFromV3 } from "./desilence.mjs";
...
test("margin + crf override", () => {
  const o = parseArgs(["in.mp4", "--out", "o.mp4", "--margin", "0.5s", "--crf", "14"]);
...
test("keepRangesFromV3 maps clip offset/dur to original seconds at fps", () => {
  ...
  assert.deepEqual(keepRangesFromV3(edl), [[0, 1], [5, 7]]);
});
